...
class RBCStylePageParser extends AbstractPageParser implements PageParserInterface
{
    /**
    ...
    {
        $nodeList = $this->findNode($DOMXPath, '//*[contains(@class, "article__header")]', true);
    ...
    {
        $nodeList = $this->findNode($DOMXPath, '//div[@class="article__main-image__inner"]//img[contains(@class, "js-rbcslider-image")]');
    ...
    {
        $nodeList = $this->findNode($DOMXPath, '//*[@class="article__date"]', true);
